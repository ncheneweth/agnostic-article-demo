...
3. Install script dependencies (python virtual env)
...
There are a default set of categories in the yaml. Try customizing the categories and descriptions. You can add a category and then experiment with descriptions to see how the model performs.  
